...
│  ├─ admin
│  │  ├─ blocks-list.php
│  │  ├─ custom-bc-admin-script.js
│  │  ├─ custom-bc-admin-style.css
│  │  ├─ form-entries-list.php
│  │  ├─ key-encryption.php
│  │  └─ settings-page.php
│  ├─ assets
...
└─ vendor
   ...
   │     │  │  └─ Webhook.php
   │     │  ├─ Exceptions
   │     │  │  ├─ MailerLiteException.php
   │     │  │  ├─ MailerLiteHttpException.php
   │     │  │  └─ MailerLiteValidationException.php
   │     │  ├─ Helpers
   │     │  │  ├─ BuildUri.php
   │     │  │  └─ HttpErrorHelper.php
   │     │  └─ MailerLite.php
